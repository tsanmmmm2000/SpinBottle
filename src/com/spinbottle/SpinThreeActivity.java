...
public class SpinThreeActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_spin_three);
		...
		TextView three_user1 = (TextView)findViewById(R.id.three_user1);
		TextView three_user2 = (TextView)findViewById(R.id.three_user2);
		TextView three_user3 = (TextView)findViewById(R.id.three_user3);
		three_user1.setText(m_arrayList.get(0));
		three_user2.setText(m_arrayList.get(1));
		three_user3.setText(m_arrayList.get(2));
	
		
		img_user1 = (ImageView) findViewById(R.id.three_ironman); 
		img_user2 = (ImageView) findViewById(R.id.three_captain_america); 
        img_user3 = (ImageView) findViewById(R.id.three_hawkeye); 
		...
		if (resultCode == Activity.RESULT_OK) {
			if(requestCode == 4 || requestCode == 5 || requestCode == 6) {
				...
				try {
					...
					if(requestCode == 4) {
						((ImageView) findViewById(R.id.three_ironman)).setImageBitmap(bmp); 
					} else if(requestCode == 5) {
						((ImageView) findViewById(R.id.three_captain_america)).setImageBitmap(bmp); 
					}else if(requestCode == 6) {
						((ImageView) findViewById(R.id.three_hawkeye)).setImageBitmap(bmp); 
					}
				...
				if(requestCode == 1) {
					((ImageView) findViewById(R.id.three_ironman)).setImageBitmap(bitmap);  // 將圖片顯示在ImageView裡
				} else if(requestCode == 2) {
					((ImageView) findViewById(R.id.three_captain_america)).setImageBitmap(bitmap); 
				}else if(requestCode == 3) {
					((ImageView) findViewById(R.id.three_hawkeye)).setImageBitmap(bitmap); 
				}
			}
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.spin_three, menu);
		return true;
	}
	...
	public void onClick(View v) {
    	...
    	if(head_or_tail == 0) {
        	...
        	iv.setBackgroundResource(R.drawable.spin_rightdown);
        	winner = m_arrayList.get(1);
        	winner_icon = R.drawable.captain_america;
        }else {
        	iv.setBackgroundResource(R.drawable.spin_leftdown);
    ...
    protected void dialog(String winner,int winner_icon){
        ...
        .setNegativeButton("離開", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
            	...
            	intent.setClass(SpinThreeActivity.this,MainActivity.class);
            	SpinThreeActivity.this.startActivity(intent); 
            }
        })
