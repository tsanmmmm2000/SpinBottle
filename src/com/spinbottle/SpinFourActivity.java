...
public class SpinFourActivity extends Activity implements OnClickListener{

	ArrayList<String> m_arrayList;
	ImageView iv = null;
	ImageView img_user1 = null;
	ImageView img_user2 = null;
	ImageView img_user3 = null;
	ImageView img_user4 = null;
	Boolean isRun = true;
	String winner;
	int winner_icon;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_spin_four);
		...
		TextView four_user1 = (TextView)findViewById(R.id.four_user1);
		TextView four_user2 = (TextView)findViewById(R.id.four_user2);
		TextView four_user3 = (TextView)findViewById(R.id.four_user3);
		TextView four_user4 = (TextView)findViewById(R.id.four_user4);
		four_user1.setText(m_arrayList.get(0));
		four_user2.setText(m_arrayList.get(1));
		four_user3.setText(m_arrayList.get(2));
		four_user4.setText(m_arrayList.get(3));
		
		
		img_user1 = (ImageView) findViewById(R.id.four_spiderman); 
		img_user2 = (ImageView) findViewById(R.id.four_captain_america); 
        img_user3 = (ImageView) findViewById(R.id.four_ironman); 
        img_user4 = (ImageView) findViewById(R.id.four_hawkeye); 
        ...
        img_user3.setOnClickListener(new OnClickListener() {
        	@Override
        	public void onClick(View v) {
        		iscamera_dialog(3);
        ...
        img_user4.setOnClickListener(new OnClickListener() {
        	@Override
        	public void onClick(View v) {
        		iscamera_dialog(4);
		...
		if (resultCode == Activity.RESULT_OK) {
			if(requestCode == 5 || requestCode == 6 || requestCode == 7 || requestCode == 8) {
				...
				try {
					...
					if(requestCode == 5) {
						((ImageView) findViewById(R.id.four_spiderman)).setImageBitmap(bmp); 
					} else if(requestCode == 6) {
						((ImageView) findViewById(R.id.four_captain_america)).setImageBitmap(bmp); 
					} else if(requestCode == 7) {
						((ImageView) findViewById(R.id.four_ironman)).setImageBitmap(bmp); 
					} else if(requestCode == 8) {
						((ImageView) findViewById(R.id.four_hawkeye)).setImageBitmap(bmp); 
					}
				...
				if(requestCode == 1) {
					((ImageView) findViewById(R.id.four_spiderman)).setImageBitmap(bitmap);  // 將圖片顯示在ImageView裡
				} else if(requestCode == 2) {
					((ImageView) findViewById(R.id.four_captain_america)).setImageBitmap(bitmap); 
				}else if(requestCode == 3) {
					((ImageView) findViewById(R.id.four_ironman)).setImageBitmap(bitmap); 
				}else if(requestCode == 4) {
					((ImageView) findViewById(R.id.four_hawkeye)).setImageBitmap(bitmap); 
				}
			}			
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.spin_four, menu);
		return true;
	}
	...
	public void onClick(View v) {
    	...
    	int head_or_tail = getRandom(0,3);

    	if(head_or_tail == 0) {
    		iv.setBackgroundResource(R.drawable.spin_up);
        	winner = m_arrayList.get(0);
        	winner_icon = R.drawable.spiderman;
        } else if(head_or_tail == 1){
        	iv.setBackgroundResource(R.drawable.spin_right);
        	winner = m_arrayList.get(1);
        	winner_icon = R.drawable.captain_america;
        }else if(head_or_tail == 2) {
        	iv.setBackgroundResource(R.drawable.spin_down);
        	winner = m_arrayList.get(2);
        	winner_icon = R.drawable.ironman; 
        } else {
        	iv.setBackgroundResource(R.drawable.spin_left);
        	winner = m_arrayList.get(3);
    ...
    protected void dialog(String winner,int winner_icon){
        ...
        .setNegativeButton("離開", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
            	...
            	intent.setClass(SpinFourActivity.this,MainActivity.class);
            	SpinFourActivity.this.startActivity(intent); 
            }
        })
